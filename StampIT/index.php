...
<div id="footer">
   <div class="container-fluid footericon">
      <div class="row">
       ...
       <div class="col"><a href="index.php?underside=maps.php"><i class="fas fa-map-marked-alt"></i></a></div>
       <div class="col"><a href="index.php?underside=profile.php"><i class="fas fa-user"></i></a></div>
    </div>
 </div>
</div>
